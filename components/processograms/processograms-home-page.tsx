...
import ProcessogramList from "@/components/processograms/processogram-list"
...
const ProcessogramHomePage = ({file_names,folder}:IProcessogramsHomePage) => {
    ...
    return (                
        <ProcessogramContext.Provider value={pigsContextValue}>
            <ProcessogramList folder={folder} file_names={file_names} />
        </ProcessogramContext.Provider>        
    )
}

export default ProcessogramHomePage