...
export const Option = styled.div`
    ...
    ${OptionIcon}{
        path,g{        
            fill:${({theme,type}) => ColorType({theme,type})} !important;
        }
        transition: transform 500ms;
    }
    :hover{
        ...
        ${OptionText}{
            color:${({theme,type}) => lighten(0.2,ColorType({theme,type}))};
            transform:scale(1.1);
            transition: transform 500ms;
        }
        ${OptionIcon}{
            path,g{        
                fill:${({theme,type}) => lighten(0.2,ColorType({theme,type}))} !important;
