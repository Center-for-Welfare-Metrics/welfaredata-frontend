...
export default {
  ...
  uploadLocalFile: (_id:string,formData:any,uploadProgress:any) => api.patch<ICommonDataEntry>(p(`${_id}/upload`),formData,{headers:{'content-type':'multipart/form-data'},onUploadProgress:uploadProgress}),
}