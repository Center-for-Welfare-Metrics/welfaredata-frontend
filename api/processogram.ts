...
export default {
  ...
  getOneReference: (fieldReference,data:{name:string,specie:SpeciesTypes}) => api.post(`${fieldReference}/getOneReference`,data),
  ...
  updateReference: (fieldReference,_id:string,data:any,specie) => api.patch(`${fieldReference}/${_id}/${specie}`,data),
